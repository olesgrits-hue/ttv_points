...
Зритель тратит Channel Points
   ...
   ttweaks слушает Twitch EventSub
         │
         ├─► Медиафайл → воспроизводит видео/GIF в OBS Browser Source
...
| 🎵 | **Яндекс Музыка** | Зритель пишет название — музыка играет с анимацией виниловой пластинки |

**Дополнительно:**

- 🗂 **Группы оверлеев** — несколько независимых Browser Source (например, отдельный для музыки)
...
Положи файл в любую папку, запусти. Установка не нужна.
